...
<html>
    ...
    $query = "SELECT first_name ,last_name , name, Position, email FROM works_at as a INNER JOIN contact as b on a.pid = b.pid INNER JOIN company as c on a.cid = c.cid";
